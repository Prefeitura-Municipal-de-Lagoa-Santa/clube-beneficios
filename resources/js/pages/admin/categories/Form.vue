    ...
    <div class="mx-auto max-w-lg">
        ...
        <form @submit.prevent="submit" class="space-y-6 rounded-lg bg-white p-6 shadow">
            ...
            <div>
                ...
                <input v-model="form.icon" type="text" placeholder="ex: Heart, ShoppingBag" class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none" />
            </div>
