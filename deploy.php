...
set('application', 'Laravel-BeneficiosLS');
...
set('repository', 'git@github.com:Prefeitura-Municipal-de-Lagoa-Santa/clube-beneficios.git');
set('keep_releases', 3);
...
host('production')
    ...
    ->set('port', 22)
    ->set('deploy_path', '/var/www/beneficios')
    ->set('branch', 'main');
...
desc('Rodar seeder: RoleSeeder (permissões e papéis)');
task('seed:roles', function () {
    $cmd = 'php artisan db:seed --class="Database\\Seeders\\RoleSeeder" --force';
